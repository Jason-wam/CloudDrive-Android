...
open class RoundCornerImageView(context: Context, attrs: AttributeSet?) : AppCompatImageView(context, attrs) {
    ...
    init {
        val typedArray = context.theme.obtainStyledAttributes(attrs, R.styleable.RoundCornerImageView, 0, 0)
